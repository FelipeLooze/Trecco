...
import com.example.trecco.adapters.MemberListItemsAdapter
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
            ...
            try {
                ...
                dataObject.put(Constants.FCM_KEY_TITLE, "Designado ao quadro $boardName")
                dataObject.put(
                    Constants.FCM_KEY_MESSAGE,
                    "Voce foi designado a um novo quadro por ${mAssignedMembersList[0].name}"
                )
